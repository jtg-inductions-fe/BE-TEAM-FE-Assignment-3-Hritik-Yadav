...
describe("RestaurantCard", () => {
  ...
  test("displays restaurant details", () => {
    render(<RestaurantCard restaurant={restaurant} onUpdate={jest.fn()} onDelete={jest.fn()} />);
  ...
  test("invokes update and delete handlers", async () => {
    ...
    render(<RestaurantCard restaurant={restaurant} onUpdate={onUpdate} onDelete={onDelete} />);
